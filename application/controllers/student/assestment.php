...
//            $questions = $this->questions->get_questions($lecture_id);
    ...
    function history(){
        ...
        $courseDDL = $this->assign_course->get_assigned_course_dropdownByYearSection($student['year_id'],$student['section_id'],$student['id']);
    ...
    function get_lectures($assign_course_id){
        // Get Lectures
        $lectures = $this->course_lecture->get_lecturesByFilters(array('assign_course_id'=>$assign_course_id, 'publish_assestment' => 1, 'is_assignment'=> 0));
        echo $lectures;
    }
