...
class Users_Model  extends CI_Model  {
 ...
 function __construct()
    ...
    //returns first_name of the uid passed
    function get_ion_auth_user_id($user_id,$table_name)
    {
    ...
    function check_duplicate_student($value,$row_id)
    {
     ...
     function check_duplicate_teacher($value,$row_id)
    {
    	$query_1 = $this->db->get_where('user_teacher',array('id' => $row_id));
    	$result_1=$query_1->result();
    	$user_id_1=$result_1[0]->user_id;
