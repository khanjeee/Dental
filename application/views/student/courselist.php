...
$html =  "<br/><br/>
            ...
            "<tr class='th_id'><td style='width:100px;'>Code</td><td>Course</td><td style='width:100px;'>Course Detail</td><td style='width:100px;'>Assignments</td></tr>";

if(count($list) > 0){
    foreach($list as $item){
        $html .= "<tr><td>".$item['code']. "</td><td>".$item['name']."</td><td style='text-decoration: none;
                color: #007fda;'>". anchor('student/courses/view/'. $item['assign_course_id'] , 'view')."</td>".

                "<td style='text-decoration: none;
                color: #007fda;'>". anchor('student/courses/assignments/'. $item['assign_course_id'] , 'view')."</td>
            </tr>";
    }
}else {
