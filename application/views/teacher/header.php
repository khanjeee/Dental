...
<ul>
<li class="btm-brd"><a href="<?php echo base_url();?>teacher/dashboard/profile/edit/<?php echo $header['teacher_id'];?>">Profile</a></li>
<li class="btm-brd"><a href="<?php echo base_url();?>teacher/dashboard">Dashboard</a></li>
...
<?php $this->load->view('teacher/links');?>
